...
```bash
python3 <skill-base>/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
```bash
python3 <skill-base>/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
```bash
python3 <skill-base>/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 <skill-base>/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 <skill-base>/scripts/search.py "<keyword>" --stack <stack>
```
