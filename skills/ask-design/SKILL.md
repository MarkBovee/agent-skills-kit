...
```bash
python3 <path-to-this-skill>/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
```bash
python3 <path-to-this-skill>/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 <path-to-this-skill>/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 <path-to-this-skill>/scripts/search.py "<keyword>" --stack <stack>
```
