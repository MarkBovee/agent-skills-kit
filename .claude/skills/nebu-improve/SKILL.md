...
when_to_use: "Common triggers: improve, audit, tech debt, tech debt audit, audit codebase, improve codebase, direction, next steps, what should we do next, plan this, audit and plan."
---
# Nebu Improve
