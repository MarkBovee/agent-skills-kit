...
- github-issues: Use when creating a GitHub issue from a bug report, review finding, failed attempt, or requested...
- improve: Use when the codebase needs a structured audit, audit-driven plans, execution of those plans, or...
- kaizen: Default baseline skill for normal software work: small safe iterations, built-in validation, no u...
- kickoff: Use when the goal, constraints, or success criteria are not yet crisp — from fuzzy design ideas t...
