...
description: "Use when creating or revising skills and you want them short, searchable, trigger-focused, and easy for the model to actually follow. Common triggers: create skill, revise skill, skill design, trigger-focused, write skills."
---
# Writing Nebu Skills
