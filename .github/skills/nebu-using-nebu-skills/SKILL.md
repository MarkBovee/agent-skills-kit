...
description: "Choose a Nebu workflow skill when starting software work, asking for autopilot mode, saying ga door or werk door, or deciding how to keep going without unnecessary stop points. Common triggers: choose a skill, which skill, autopilot mode, keep going, continue without waiting, ga door, werk door, ga verder, zonder te wachten, niet stoppen, start software work, skill router, workflow selection."
---
# Using Nebu Skills
