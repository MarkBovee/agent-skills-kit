...
description: "Discovery fallback for hosts without the router plugin: pick the right Nebu workflow skill for the current task. When the OpenCode router plugin is active, prefer its hints instead of loading this skill. Common triggers: choose a skill, which skill, start software work, skill router, workflow selection."
---
# Using Nebu Skills
