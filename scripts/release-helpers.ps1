...
function Test-IsGeneratedPlatformStatusLine {
    ...
    return $path.StartsWith(".claude/") -or $path.StartsWith(".dsh/") -or $path.StartsWith(".github/skills/") -or $path.StartsWith(".github/prompts/") -or $path -eq ".github/copilot-instructions.md"
}
